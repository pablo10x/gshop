<script lang="ts">
  ...
  import { Button, Table, Modal, Input, Label, Textarea, Spinner } from 'flowbite-svelte';
  import { fade, slide } from 'svelte/transition';
  import type { Product } from '$lib/models/product';
  import type { AnyGelDeleteBase } from 'drizzle-orm/gel-core';
...
>
  ...
  >
    ...
    <div class="flex justify-end gap-4">
      ...
      <Button type="submit" gradient color="blue">
